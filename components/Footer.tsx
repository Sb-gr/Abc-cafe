  ...
  return (
    <footer className="bg-coffee-900 text-[#FAF9F6]">
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-serif font-bold text-white">ABC Cafe</span>
            </Link>
        ...
        <div className="mt-16 pt-8 border-t border-coffee-800 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} ABC Cafe – Birtamod, Jhapa. All Rights Reserved.</p>
          <p className="mt-2 text-xs italic">स्वाद, स्नेह र सन्तुष्टि</p>
        </div>
      </div>
    </footer>
  );
